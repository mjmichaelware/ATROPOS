...
android {
    ...
    // Must match the Kotlin version applied to this module. AGP fails the
    // build with an explicit version-mismatch message when it does not, which
    // is the one Compose misconfiguration that reports itself clearly.
    composeOptions {
