...
import atropos.cli.input.CommandGroup
...
object HelpRegistry {
    ...
    fun commandEntries(): List<CommandEntry> = CommandRegistry.entries

    fun commandSections(): List<CommandGroup> = CommandRegistry.helpSections()

    fun commandHelpLines(): List<String> = CommandRegistry.helpLines()
