...
/**
 * Built-in themes. ATROPOS keeps its electric-red-on-black identity as the default; the
...
object ThemeCatalog {
    ...
    /** ATROPOS default: deep-but-bright electric red identity, high contrast, dark. */
    private val atroposDark = ThemePalette(
        id = "atropos-dark",
        displayName = "ATROPOS Dark",
        isDark = true,
        styles = mapOf(
            Role.BRAND to RoleStyle("1;31", "1;38;5;197", "1;38;2;255;23;68"),
            Role.BRAND_MUTED to RoleStyle("31", "38;5;160", "38;2;196;0;29"),
            ...
            Role.STATUS_RUNNING to RoleStyle("1;31", "1;38;5;197", "1;38;2;255;23;68"),
            ...
            Role.PATH to RoleStyle("31", "38;5;203", "38;2;255;110;130"),
            ...
            Role.DIFF_HUNK to RoleStyle("31", "38;5;160", "38;2;196;0;29")
        )
    )
    ...
    private val atroposLight = ThemePalette(
        ...
        isDark = false,
        styles = mapOf(
            Role.BRAND to RoleStyle("1;31", "1;38;5;160", "1;38;2;196;0;29"),
            Role.BRAND_MUTED to RoleStyle("31", "38;5;124", "38;2;153;0;23"),
            ...
            Role.STATUS_RUNNING to RoleStyle("31", "38;5;160", "38;2;196;0;29"),
            ...
            Role.PATH to RoleStyle("31", "38;5;124", "38;2;153;0;23"),
            ...
            Role.DIFF_HUNK to RoleStyle("31", "38;5;124", "38;2;153;0;23")
        )
    )
