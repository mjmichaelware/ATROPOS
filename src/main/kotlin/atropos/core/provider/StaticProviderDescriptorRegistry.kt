...
class StaticProviderDescriptorRegistry : ProviderDescriptorRegistry {
    private val descriptors = listOf(
        ...
        d("together","Together AI",CostMode.PAID_LOCKED,6,c(ApiCapability.CHAT,ApiCapability.CODE,ApiCapability.REPAIR,ApiCapability.PLAN),e("TOGETHER_API_KEY"),f("openrouter","groq"),"provider.together.chat"),
        d("fireworks","Fireworks AI",CostMode.PAID_LOCKED,6,c(ApiCapability.CHAT,ApiCapability.CODE,ApiCapability.REPAIR,ApiCapability.PLAN),e("FIREWORKS_API_KEY"),f("openrouter","groq"),"provider.fireworks.chat"),
        d("azure_openai","Azure OpenAI",CostMode.PAID_LOCKED,8,c(ApiCapability.CHAT,ApiCapability.CODE,ApiCapability.REPAIR,ApiCapability.PLAN),e("AZURE_OPENAI_API_KEY","AZURE_OPENAI_ENDPOINT"),f("openrouter","groq"),"provider.azure_openai.chat"),
