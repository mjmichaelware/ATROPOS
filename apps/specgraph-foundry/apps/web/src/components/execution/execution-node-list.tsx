  ...
  return (
    <>
      <p className="sg-muted">
        Each row is one stage of the plan being carried out by the connected runtime system. Server-ready means the platform itself has confirmed this node&apos;s dependencies are satisfied and it
        can start — that call is never made client-side. A lease owner shows which worker currently holds the node, if any.
      </p>
