...
text src/main/kotlin/atropos/Main.kt 'ProviderOnboardingService().renderLaunchSummary(refresh = true)'
...
text src/main/kotlin/atropos/Main.kt 'renderLaunchSummary(refresh = true)'
