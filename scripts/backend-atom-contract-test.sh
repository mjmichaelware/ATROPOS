...
text src/test/kotlin/atropos/core/provider/ProviderFixtureMatrixServiceTest.kt 'metadata_fields_are_not_transport_aliases'
for provider_id in \
...
text src/main/kotlin/atropos/core/provider/adapter/AdapterRegistry.kt 'flatMap { it.requiredEnv }'
...
text src/test/kotlin/atropos/core/provider/ProviderTruthModelsTest.kt 'truth_projection_excludes_provider_disabled_in_launch_inventory'
...
text src/main/kotlin/atropos/Main.kt 'sharedMcpHostManager = mcpHostManager'
text src/main/kotlin/atropos/Main.kt 'onboarding = providerOnboarding'
text src/main/kotlin/atropos/bridge/AtroposBridge.kt 'if (onboarding == null) providerOnboarding.refresh()'
...
text src/main/kotlin/atropos/cli/commands/SelfHostCommand.kt 'SelfHostGoalService(repoRoot, onboarding = onboarding)'
text src/main/kotlin/atropos/cli/commands/SelfHostCommand.kt 'DagExecutionService(config, repoRoot, onboarding = onboarding)'
text src/main/kotlin/atropos/cli/commands/AgentCommand.kt 'onboarding = providerOnboarding'
text src/main/kotlin/atropos/Main.kt 'SelfHostStartupContinuationService(onboarding = providerOnboarding)'
text src/main/kotlin/atropos/core/agent/SelfHostStartupContinuationService.kt 'SelfHostGoalService(onboarding = onboarding)'
text src/main/kotlin/atropos/core/recovery/CrashRecoveryService.kt 'AgentQueueService(config, onboarding = onboarding)'
text src/main/kotlin/atropos/core/recovery/CrashRecoveryService.kt 'DagExecutionService(config, repoRoot, onboarding = onboarding)'
text src/main/kotlin/atropos/Main.kt 'CrashRecoveryService(config = config, onboarding = providerOnboarding)'
text src/main/kotlin/atropos/bridge/AtroposBridge.kt 'crashRecovery = CrashRecoveryService('
...
text src/main/kotlin/atropos/cli/FirstRunProbe.kt 'private val onboarding: ProviderOnboardingService? = null'
text src/main/kotlin/atropos/cli/CommandRouter.kt 'FirstRunProbe(config, onboarding = providerOnboarding)'
file src/test/kotlin/atropos/cli/FirstRunProbeTest.kt
...
text src/test/kotlin/atropos/core/github/GitHubApiClientTest.kt 'graphql_file_blame_is_read_only_but_uses_the_same_gated_transport'
...
text src/main/kotlin/atropos/core/factory/FactoryRunOrchestrator.kt 'evidencePath = generatedProject.evidencePath'
text src/main/kotlin/atropos/core/factory/FactoryRunHandoff.kt 'evidence_path='
text src/main/kotlin/atropos/cli/FactoryCommandHandler.kt 'resume executed:'
